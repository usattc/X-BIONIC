...
//        NSLog(@"测试%@", [NSNumber numberWithInteger:_speciaCellID]);
        [_delegate didClickWithProductListDictionary:@{@"specialCellID":[NSNumber numberWithInteger:_speciaCellID], @"productList":_productListArr[indexPath.row]}];
//         _productList[indexPath.row] andSpecialCellID:_speciaCellID];
    }
//    if (_cellID == 1) {
